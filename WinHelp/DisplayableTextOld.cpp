/* Displayable text old version class implementation.
...
DisplayableTextOld::DisplayableTextOld(const void *src,
    size_t srcSize,
    const void *textSrc,
    size_t textSize,
    QTextCodec *codec,
    ...
    int topicNumber,
    QList<WinHelpPicture> &embeddedImages) : DisplayableText(0x01,
    topicDescriptorNumber, topicNumber), paragraphs(), texts()
{
    ...
    PRINT_DBG("Loading displayable text old");
    ...
    PRINT_DBG("Displayable text old loaded successfully");
}

DisplayableTextOld::DisplayableTextOld(const DisplayableTextOld& rhs) :
    DisplayableText(rhs), topicSize(rhs.topicSize), paragraphs(rhs.paragraphs),
    texts(rhs.texts)
{
    PRINT_DBG("Displayable text old copy constructor");
}

DisplayableTextOld::~DisplayableTextOld()
{
    PRINT_DBG("Displayable text old destructor");
}

DisplayableTextOld & DisplayableTextOld::operator=(
    const DisplayableTextOld & rhs)
{
    PRINT_DBG("Displayable text old assignment operator");
    if (this != &rhs)
    {
...
QList<TopicOffset> DisplayableTextOld::getHyperlinks() const
{
...
QString DisplayableTextOld::getHTML(bool &empty) const
{
    QString result;
    int textLength = 0;
    ...
    for(int i = 0; i < this->texts.count(); i++)
    {
        ...
        if(i < this->paragraphs.at(0).commands.count())
        {
            ...
            case TYPE_86:
            {
                ...
                result += escapedString;
                switch(this->paragraphs.at(0).commands.at(i).dynamicCast<
                            Type86Command>()->getDataType())
                {
                case EMBEDDED_OBJECT_DATA:
                    break;
                ...
                case EMBEDDED_PICTURE_DATA_TYPE_3:
                {
                    if(this->paragraphs.at(0).commands.at(i).dynamicCast<
                                    Type86Subtype3Command>()->
                                getPictureIsEmbedded() ==
                                0)
                    {
                        result += QString(
                                    "<img style=\"border-style: none\" src=\"help://help.local/pages?image=%1\" alt=\"Image\" />")
                                    .arg(this->paragraphs.at(0).commands.at(
                                        i).dynamicCast<Type86Subtype3Command>()
                                    ->
                                    getPictureNumber());
                    }
                    else
                ...
                case EMBEDDED_PICTURE_DATA_TYPE_22:
                {
                                ...
                                0)
                    {
                        result += QString(
                                    "<img style=\"border-style: none\" src=\"help://help.local/pages?image=%1\" alt=\"Image\" />")
                                    .arg(this->paragraphs.at(0).commands.at(
                                        i).dynamicCast<Type86Subtype22Command>()
                                    ->
                                    getPictureNumber());
                    }
                    else
                ...
                case EMBEDDED_PICTURE_DATA_TYPE_3:
                {
                                ...
                                0)
                    {
                        result += QString(
                                    "<img style=\"border-style: none\" src=\"help://help.local/pages?image=%1\" alt=\"Image\" />")
                                    .arg(this->paragraphs.at(0).commands.at(
                                        i).dynamicCast<Type87Subtype3Command>()
                                    ->
                                    getPictureNumber());
                    }
                    else
                ...
                case EMBEDDED_PICTURE_DATA_TYPE_22:
                {
                                ...
                                0)
                    {
                        result += QString(
                                    "<img style=\"border-style: none\" src=\"help://help.local/pages?image=%1\" alt=\"Image\" />")
                                    .arg(this->paragraphs.at(0).commands.at(
                                        i).dynamicCast<Type87Subtype22Command>()
                                    ->
                                    getPictureNumber());
                    }
                    else
                ...
                case EMBEDDED_PICTURE_DATA_TYPE_3:
                {
                                ...
                                0)
                    {
                        result += QString(
                                    "<img style=\"border-style: none\" src=\"help://help.local/pages?image=%1\" alt=\"Image\" />")
                                    .arg(this->paragraphs.at(0).commands.at(
                                        i).dynamicCast<Type88Subtype3Command>()
                                    ->
                                    getPictureNumber());
                    }
                    else
                ...
                case EMBEDDED_PICTURE_DATA_TYPE_22:
                {
                                ...
                                0)
                    {
                        result += QString(
                                    "<img style=\"border-style: none\" src=\"help://help.local/pages?image=%1\" alt=\"Image\" />")
                                    .arg(this->paragraphs.at(0).commands.at(
                                        i).dynamicCast<Type88Subtype22Command>()
                                    ->
                                    getPictureNumber());
                    }
                    else
